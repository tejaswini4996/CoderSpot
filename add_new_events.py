...
NEW_EVENTS = [
    ...
    (
        "Fund My Crazy 2026 (Google Gemini)", "contest", "September",
        "Applications close September 15, 2026", "all", "Remote",
        "A Google Gemini initiative for Indian college and university students: pick one of six urban-life categories, brainstorm and visualize your idea using Gemini, and submit — no coding or working prototype required. Total prize pool of ₹1 crore, with top winners receiving ₹20 lakh each. Open to individuals or teams of up to 3.",
        "https://fundmycrazy.com/",
    ),
    (
        "Hack With Hyderabad 3.0", "contest", "October",
        "In-person event on October 5, 2026", "all", "In-person",
        "An in-person hackathon hosted at Microsoft's office in Hyderabad, bringing together developers and builders for a day of hacking, collaboration, and networking.",
        "https://devnovate.co/event/hack-with-hyderabad-30/",
    ),
    (
        "NASA International Space Apps Challenge", "contest", "October",
        "Annual 48-hour global hackathon, held in October", "all", "Hybrid",
        "The world's largest annual global hackathon: teams around the world spend 48 hours building solutions using open NASA space and Earth science data, at hundreds of local host locations plus a virtual track.",
        "https://www.spaceappschallenge.org/",
    ),
    (
        "ETHGlobal Hackathons", "contest", "March",
        "Multiple events run throughout the year worldwide — check the schedule", "all", "Hybrid",
        "A recurring global series of large in-person and online Ethereum and Web3 hackathons (past editions include ETHGlobal Tokyo, Berlin, and online events), with substantial prize pools from ecosystem sponsors.",
        "https://ethglobal.com/",
    ),
    (
        "Meta Hacker Cup", "contest", "August",
        "Qualification rounds typically begin in August, finals later in the year", "all", "Remote",
        "Meta's annual global algorithmic and competitive programming contest, open to programmers of all skill levels, with multiple online qualifying rounds leading to an onsite final.",
        "https://www.facebook.com/codingcompetitions/hacker-cup",
    ),
    (
        "Imagine Cup by Microsoft", "contest", "October",
        "Registrations typically open in the fall, with regional and world finals the following year", "all", "Hybrid",
        "Microsoft's flagship global student technology competition, challenging student entrepreneurs and developers to build AI and cloud-powered solutions for a chance at funding, mentorship, and Azure credits.",
        "https://imaginecup.microsoft.com/",
    ),
    (
        "Topcoder Open (TCO)", "contest", "November",
        "Online qualifying rounds run throughout the year; onsite finals typically in the fall", "all", "Hybrid",
        "Topcoder's flagship annual tournament spanning algorithm, development, design, data science, and QA tracks, culminating in an onsite championship final with cash prizes.",
        "https://www.topcoder.com/community/member-programs/topcoder-open",
    ),
    (
        "Hack Club Stipends & Hardware Grants", "open_source", "June",
        "Rolling — apply anytime through Hack Club's programs", "all", "Remote",
        "Hack Club offers rolling hardware grants, project stipends, and hackathon support specifically for high school and teenage developers building their own projects and running local hackathons.",
        "https://hackclub.com/",
    ),
    (
        "Smart India Hackathon (SIH)", "contest", "August",
        "Nationwide hackathon typically held in August", "all", "In-person",
        "India's largest nationwide hackathon, run by the Government of India, challenging university students to build solutions to real government and industry problem statements across hardware and software tracks.",
        "https://www.sih.gov.in/",
    ),
    (
        "Flipkart GRiD", "contest", "July",
        "Registrations typically open in June-July annually", "all", "Hybrid",
        "Flipkart's flagship annual engineering campus challenge for Indian engineering students, spanning Software Development, AI Engineering, and Data Science tracks, used as a direct hiring pipeline into Flipkart internships and full-time roles.",
        "https://internshala.com/competitions/flipkart-grid-8-0/",
    ),
    (
        "Kaggle Featured Competitions", "contest", "January",
        "New competitions launch continuously year-round — check the current listings", "all", "Remote",
        "Kaggle's ongoing lineup of machine learning and data science competitions, often sponsored by major companies with large cash prize pools, open to participants of any experience level.",
        "https://www.kaggle.com/competitions",
    ),
    (
        "Build, Ship, Shape: Amazon Developer Hackathon", "contest", "October",
        "Submissions close October 23, 2026", "all", "Remote",
        "An Amazon-run hackathon challenging developers to build with Amazon devices and services — including Fire TV, Alexa+, Ring, and Amazon Bee. Over $190,000 in prizes and devices up for grabs.",
